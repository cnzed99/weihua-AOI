     ...
     out HTuple hv_VState, out HTuple hv_VStride)
        {
            ...
            try
            {
                ...
                HOperatorSet.GenRectangle1(out ho_RegionOpening1, 0, 0, hv_Height, hv_Width);
                HOperatorSet.ErosionRectangle1(ho_RegionOpening1, out ho_RegionTrans, hv_Height / 2, hv_Width / 2);
     ...
     out HTuple hv_VState, out HTuple hv_VStride,out bool isWhiteZipper)
        {
            ...
            try
            {
                ...
                if (hv_HValue.D<130&&hv_SValue.D<45&& hv_VValue.D>185) //白色拉链加严处理
                {
                    isWhiteZipper = true;
                }
