      ...
      HTuple hv_MaxRow, HTuple hv_Radius, out HTuple hv_OutFlagCap)
        ...
        public override void DetectImage(Cell cell)
        {
            ...
            if ((param.CapMinRow > 0) && (param.CapMaxRow > 0))
            {
                ...
                try
                {
                    InspectionBlueCap(tempCameraImageInfo.CameraImage, param.BlueCapBrightness, param.CapMinRow, param.CapMaxRow, param.BlueCapDiameter * 0.5, param.BlueCapThickness, out bFlagBlueCap);
            ...
            try
            {
                InspectionLabel(tempCameraImageInfo.CameraImage, param.LabelBrightness, param.LabelMinRow, param.LabelMaxRow - 100,param.BottleDiameter*0.5, out bFlagLabel);
                lock (m_WaitImage_globalLock)
                {
                    if (bFlagLabel.I == 1)
                    {
...
public partial class CPcParam : CParamBase
{
    ...
    [ObservableProperty]
    [property: Category("标签检测")]
    [property: DisplayName("标签亮度")]
    [property: Description("标签亮度")]
    private int labelBrightness = 70;
    ...
    [ObservableProperty]
    [property: Category("瓶盖检测参数")]
    [property: DisplayName("蓝盖亮度")]
    [property: Description("蓝盖亮度")]
    private int blueCapBrightness = 100;
