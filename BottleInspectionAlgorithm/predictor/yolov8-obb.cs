    ...
    public class YOLOv8Obb : YOLO
    {
        public YOLOv8Obb(
            ...
            : base(
                ...
                new List<int[]> { new int[] { 1, 5 + categ_nums, (int)ImgSize.S640 } },
        ...
        protected override BaseResult postprocess(List<float[]> results)
        {
            ...
            for (int i = 0; i < result_data.Rows; i++)
            {
                ...
                OpenCvSharp.Point max_classId_point,
                    min_classId_point;
                double max_score,
                    min_score;
                ...
                Cv2.MinMaxLoc(
                    ...
                    out min_score,
                    out max_score,
                    out min_classId_point,
                    out max_classId_point
                );
                classes_scores.Dispose();
