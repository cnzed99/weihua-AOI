...
namespace UDPIP
{
    public partial class CUdpIpCommunicationSetting : CCommunicationSettingBase
    {
        public CUdpIpCommunicationSetting()
            : base() { }
    ...
    public partial class CDataInfo : ConfigModifyObservableBase
    {
        ...
        public int DataIndex
        {
            ...
            set
            {
                if (value + DataLength >= CUdpIpCommPart.MaxbuffLength)
                    Growl.Error($"索引加长度超出最大数据长度{CUdpIpCommPart.MaxbuffLength}!");
                else
        ...
        public int DataLength
        {
            ...
            set
            {
                if (value + DataIndex >= CUdpIpCommPart.MaxbuffLength)
                    Growl.Error($"索引加长度超出最大数据长度{CUdpIpCommPart.MaxbuffLength}!");
                else
