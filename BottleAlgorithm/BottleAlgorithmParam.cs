    ...
    public class CBottleAlgorithmParam : GeneralMLOBBAlgorithmParam
    {
       ...
       // private bool m_bFlagInitialAlgorithmParam;
        ...
        public CBottleAlgorithmParam() : base()
        {
            ...
            DefectSpecies.Add(new("西林瓶有无类", new() { new("瓶盖", Category.区域), new("标签", Category.区域), }));
        ...
        public override void DetectImage(Cell cell)
        {
            ...
            if (param != null)
            {
                ...
                try
                {
                    ...
                    ho_CapRegion.Dispose(); hv_Max.Dispose();

                    //蓝盖缺失检测
                    InspectionBlueCap(ho_ImageB, ho_ImageR, out ho_CapRegion, param.BlueCapBrightnessMin, param.BlueCapBrightnessMax, CapMinRow,
                   CapMinCol, CapMaxRow, CapMaxCol, param.BlueCapThickness, out hv_Max);
                    ...
                    HOperatorSet.SmallestRectangle1(ho_CapRegion, out hv_Row1, out hv_Column1,
                    ...
                    System.Windows.Point pos = new System.Windows.Point((hv_Column2.D + hv_Column1.D) /2.0-100, (hv_Row2.D + hv_Row1.D) / 2.0);
                ...
                try
                {
                    ...
                    InspectionLabel(ho_ImageR, out ho_LabelRegion, param.LabelBrightnessMin, param.LabelBrightnessMax,
                        LabelMinRow, LabelMinCol, LabelMaxRow, LabelMaxCol, param.LabelThickness, out hv_Max1);
                    ...
                    hv_Row1.Dispose(); hv_Column1.Dispose(); hv_Row2.Dispose(); hv_Column2.Dispose();
                    HOperatorSet.SmallestRectangle1(ho_LabelRegion, out hv_Row1, out hv_Column1,
                        out hv_Row2, out hv_Column2);
                    ...
                    System.Windows.Point reclebelp1 = new System.Windows.Point(hv_Column1.I, hv_Row1.I);
                    System.Windows.Point reclebelp2 = new System.Windows.Point(hv_Column2.I, hv_Row1.I);
                    System.Windows.Point reclebelp3 = new System.Windows.Point(hv_Column2.I, hv_Row2.I);
                    System.Windows.Point reclebelp4 = new System.Windows.Point(hv_Column1.I, hv_Row2.I);
                    List<System.Windows.Point> rec1Points = new List<System.Windows.Point>();
        ...
        #region 蓝盖缺失算法
        public void InspectionBlueCap(HObject ho_ImageB, HObject ho_ImageR, out HObject ho_CapRegion,
        HTuple hv_IntoMinThreshold, HTuple hv_IntoMaxThreshold, HTuple hv_MinRow, HTuple hv_MinColumn,
        HTuple hv_MaxRow, HTuple hv_MaxColumn, HTuple hv_CapThickness,
        out HTuple hv_Max)
        {
            ...
            HObject ho_Region, ho_RegionOpening2;
            ...
            HOperatorSet.OpeningRectangle1(ho_Region, out ho_RegionOpening2, hv_CapThickness,
                hv_CapThickness);
            ho_CapRegion.Dispose();
            HOperatorSet.SelectShapeStd(ho_RegionOpening2, out ho_CapRegion, "max_area",
                70);
            hv_Min.Dispose(); hv_Max.Dispose(); hv_Range.Dispose();
            HOperatorSet.MinMaxGray(ho_CapRegion, ho_ImageReduced, 50, out hv_Min, out hv_Max,
                out hv_Range);
            ho_ImageSub.Dispose();
            ho_Rectangle.Dispose();
            ho_ImageReduced.Dispose();
        ...
        public void InspectionLabel(HObject ho_IntoImage, out HObject ho_LabelRegion,
            HTuple hv_IntoMinThreshold, HTuple hv_IntoMaxThreshold, HTuple hv_MinRow, HTuple hv_MinColumn,
            HTuple hv_MaxRow, HTuple hv_MaxColumn, HTuple hv_LabelOpeningCircle, out HTuple hv_Max)
        {
            ...
            hv_Min.Dispose(); hv_Max.Dispose(); hv_Range.Dispose();
            HOperatorSet.MinMaxGray(ho_LabelRegion, ho_ImageReduced, 50, out hv_Min, out hv_Max,
                out hv_Range);
            ho_Rectangle.Dispose();
            ho_ImageReduced.Dispose();
            ho_Region.Dispose();
