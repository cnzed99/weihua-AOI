...
namespace BottleAlgorithm
{
    public class CBottleAlgorithmParam : GeneralMLOBBAlgorithmParam
    {
            ...
            : base()
        {
            ...
            DefectSpecies.Add(
                new("西林瓶有无类", new() { new("瓶盖", Category.区域), new("倒瓶", Category.区域) })
            );
        ...
        public override void DetectImage(Cell cell)
        {
            ...
            if (param != null)
            {
                ...
                #region 倒瓶检测 倒瓶时如果触发相机不发信号，出料口倒瓶剔除不会索要结果
                ...
                #endregion 倒瓶检测 倒瓶时如果触发相机不发信号，出料口倒瓶剔除不会索要结果
    ...
    public partial class CBottleParam : CParam
    {
        ...
        /// </summary>
        [ObservableProperty]
        [property: Category("倒瓶检测")]
        [property: DisplayName("01.瓶身位置上限")]
        [property: Description("瓶身位置上限")]
        ...
        [ObservableProperty]
        [property: Category("倒瓶检测")]
        [property: DisplayName("02.瓶身位置下限")]
        [property: Description("瓶身位置下限")]
        ...
        [ObservableProperty]
        [property: Category("倒瓶检测")]
        [property: DisplayName("03.瓶身亮度下限")]
        [property: Description("瓶身亮度下限")]
        ...
        [ObservableProperty]
        [property: Category("倒瓶检测")]
        [property: DisplayName("04.瓶身亮度上限")]
        [property: Description("瓶身亮度上限")]
